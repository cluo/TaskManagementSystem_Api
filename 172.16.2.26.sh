docker kill task-management-api oauth-server-service task-management-frontend ambassador;docker rm task-management-api oauth-server-service task-management-frontend ambassador;
docker rmi 211.157.146.6:5000/task-management-api 211.157.146.6:5000/task-management-frontend 211.157.146.6:5000/oauth-server-service
